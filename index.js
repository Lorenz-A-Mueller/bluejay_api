...
const resolvers = {
  Query: {
    ...
    employees: (arg, parent, context) => {
      console.log('context: ', context);
      context.res.cookie('abc', 'abc', {
        httpOnly: true,
      });
      return getEmployees();
    },
...
//           // delete all expired sessions (even other peoples'!)
...
//           // do db query to add session
//           createCustomerSession(token, customerWithoutHashedPassword.id);
//           // set the Cookie in the requester's browser

//           // const maxAge = 60 * 5; // 5 Min.
//           // const isProduction = process.env.NODE_ENV === 'production';
//           // const thisCookie = cookie.serialize('sessionToken', token, {
//           //   maxAge: 300,
...
//           //   value: 'cookieContent',
//           //   options: {
//           //     // expires: new Date('2022-12-31T00:00:00'),
//           //     httpOnly: true,
//           //     maxAge: 3600,
//           //     path: '/',
//           //     sameSite: 'lax',
...
//           console.log('context.res.cookie: ', context.res.cookie);
